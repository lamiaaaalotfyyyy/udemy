...
export default function InstructorFooter() {
    return (
        <>
            <footer className="bg-[#2d2f31] pb-6 text-gray-100 ml-14">
                <div className="pt-8 flex gap-8 border-b border-[#3e4143] pb-8">
                    <span className="text-white font-bold tracking-normal text-2xl" >Top companies choose <span className="underline text-[#c0c4fc]" ><a href=""> Udemy Business </a></span> to build in-demand career skills.</span>
                    <Image
