...
export default function Footer() {
    return ( <
        ...
        <
        div className = "basis-1/2 flex lg:hidden sm:flex md:flex mb-3" > { " " } { /* button */ } { " " } <
        ...
        /ul>{" "} <
        /div>{" "} <
        div className = "basis-1/2 lg:flex  justify-end sm:hidden md:hidden" > { " " } { /* button */ } { " " } <
        button className = "text-white border-white border-solid border-2   h-12 min-w-40" >
        <
        div className = "flex justify-start px-6" > { " " } <
        svg xmlns = "http://www.w3.org/2000/svg"
        ...
        /button>{" "} <
        /div>{" "} <
        /div>{" "} { /* section 2 logo and copy right */ } { " " } <
